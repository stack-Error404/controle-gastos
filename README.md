...
## Atualização
O service worker usa o cache `livro-caixa-v3-final-3.2.0`. Ao publicar uma atualização futura, altere o nome do cache para garantir renovação dos arquivos.
